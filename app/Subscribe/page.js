const Subscribe = () => {
  return (
    <div className="px-[5%] lg:px-[10%] mb-10 flex justify-center text-center">
      <aside>
        <h1 className="text-xl sm:text-3xl text-[#374151] font-bolds">
        ...
        <div className="mt-7 flex justify-center">
          <input
            ...
            className="p-2 border-1 rounded-tl-sm rounded-bl-sm border-gray-500 w-[15rem] sm:w-[25rem] lg:w-[35rem] text-sm"
          />
